      ...
      <div className="container mx-auto px-4 md:px-6">
        <Card className="max-w-3xl mx-auto shadow-lg">
          ...
          <CardContent className="py-6 md:py-8 space-y-6 text-foreground/90 leading-relaxed">
            ...
            <section>
              <h2 className="font-headline text-xl font-semibold text-primary mb-3 mt-6">Interpretation and Definitions</h2>
              
              <h3 className="font-headline text-lg font-semibold text-primary/90 mt-4 mb-2">Interpretation</h3>
              <p>
              ...
              <h3 className="font-headline text-lg font-semibold text-primary/90 mt-4 mb-2">Definitions</h3>
              ...
              <ul className="list-disc list-inside pl-4 space-y-2 mt-2">
                ...
                <li>
                  ...
                  Agreement) refers to Alex Zewebrand.
                </li>
                <li>
                ...
                <li>
                  <strong>Website</strong> refers to Alex Zewebrand, accessible from{' '}
                  <a
                    href="https://alexzewebrand.com/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-accent hover:underline"
                  >
                    https://alexzewebrand.com/
                  </a>
                </li>
                <li>
            ...
            <section>
              <h2 className="font-headline text-xl font-semibold text-primary mb-3 mt-6">Collecting and Using Your Personal Data</h2>
              
              <h3 className="font-headline text-lg font-semibold text-primary/90 mt-4 mb-2">Types of Data Collected</h3>
              
              <h4 className="font-semibold text-primary/80 mt-3 mb-1">Personal Data</h4>
              <p>
              ...
              <h4 className="font-semibold text-primary/80 mt-3 mb-1">Usage Data</h4>
              ...
              <h4 className="font-semibold text-primary/80 mt-3 mb-1">Tracking Technologies and Cookies</h4>
              <p>
            ...
            <section>
              <h3 className="font-headline text-lg font-semibold text-primary/90 mt-4 mb-2">Use of Your Personal Data</h3>
            ...
            <section>
              <h3 className="font-headline text-lg font-semibold text-primary/90 mt-4 mb-2">Retention of Your Personal Data</h3>
              <p>
            ...
            <section>
              <h3 className="font-headline text-lg font-semibold text-primary/90 mt-4 mb-2">Transfer of Your Personal Data</h3>
              <p>
            ...
            <section>
              <h3 className="font-headline text-lg font-semibold text-primary/90 mt-4 mb-2">Delete Your Personal Data</h3>
              <p>
            ...
            <section>
              <h3 className="font-headline text-lg font-semibold text-primary/90 mt-4 mb-2">Disclosure of Your Personal Data</h3>
              
              <h4 className="font-semibold text-primary/80 mt-3 mb-1">Business Transactions</h4>
              <p>
              ...
              <h4 className="font-semibold text-primary/80 mt-3 mb-1">Law enforcement</h4>
              <p>
              ...
              <h4 className="font-semibold text-primary/80 mt-3 mb-1">Other legal requirements</h4>
              <p>
            ...
            <section>
              <h3 className="font-headline text-lg font-semibold text-primary/90 mt-4 mb-2">Security of Your Personal Data</h3>
              <p>
            ...
            <section>
              <h2 className="font-headline text-xl font-semibold text-primary mb-3 mt-6">Children's Privacy</h2>
              <p>
            ...
            <section>
              <h2 className="font-headline text-xl font-semibold text-primary mb-3 mt-6">Links to Other Websites</h2>
              <p>
            ...
            <section>
              <h2 className="font-headline text-xl font-semibold text-primary mb-3 mt-6">Changes to this Privacy Policy</h2>
              <p>
            ...
            <section>
              <h2 className="font-headline text-xl font-semibold text-primary mb-3 mt-6">Contact Us</h2>
              <p>If you have any questions about this Privacy Policy, You can contact us:</p>
              <ul className="list-disc list-inside pl-4 space-y-1 mt-2">
                <li>
                  By email: {' '}
                  <a
                    href="mailto:blndsft@proton.me"
                    className="text-accent hover:underline"
                  >
                    blndsft@proton.me
                  </a>
